...
exports.createSalary = async (req, res) => {
  try {
    const {
      employeeId, // new (optional but recommended)
      employeeName, // required if employeeId not provided
      role,         // required if employeeId not provided
      department,   // optional; will be filled from Employee if employeeId exists
      basicSalary,
      allowances,
      deductions,
      paymentDate,

// // frontend/src/pages/financialmanager/Expenses.jsx
...
// frontend/src/pages/financialmanager/Incomes.jsx
import React, { useState, useEffect } from "react";
import axios from "axios";
import { toast } from "react-toastify";
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Incomes</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-sm font-medium text-gray-600 uppercase tracking-wide">Total Income</h3>
            </div>
            <p className="text-3xl font-bold text-green-600">Rs {getTotalIncomes().toLocaleString()}</p>
          ...
          {getTopCategories().map((category, index) => (
            <div key={category.name} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-sm font-medium text-gray-600 uppercase tracking-wide">{category.name}</h3>
              </div>
              <p className="text-2xl font-bold text-blue-600">Rs {category.total.toLocaleString()}</p>
              <div className="mt-2 pt-2 border-t border-gray-100">
                ...
                {incomes.length === 0 ? (
                  <tr>
                    <td colSpan="6" className="px-6 py-8 text-center text-gray-500">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-1">No income records found</h3>
                      <p className="text-gray-500">Get started by adding your first income record.</p>
                    </td>
                  </tr>
                ) : (
                  incomes.map((income, index) => (
                    <tr key={income._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-3xl font-bold text-red-600">Rs {getTotalExpenses().toLocaleString()}</p>
                ...
                {expenses.length === 0 ? (
                  <tr>
                    <td colSpan="6" className="px-6 py-8 text-center text-gray-500">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-1">No expense records found</h3>
                      <p className="text-gray-500">Get started by adding your first expense record.</p>
                    </td>
                  </tr>
                ) : (
                  expenses.map((expense, index) => (
                    <tr key={expense._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>

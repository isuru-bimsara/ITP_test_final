...
export const createBeautifulEmployeePDF = ({
  ...
  // Use autoTable function (fixes: doc.autoTable is not a function)
  autoTable(doc, {
    ...
    columnStyles: {
      ...
      department: { cellWidth: 22, halign: "center", fontSize: 7 },
    ...
    didDrawPage: () => {
      ...
      doc.text(
        `Generated by: ${userName} (${userLogin})`,
        pageWidth - 14,
        pageHeight - 12,
        { align: "right" }
      );
  ...
  if (department === "All") {
    const departmentStats = employees.reduce((acc, emp) => {
      acc[emp.department || "Unknown"] =
        (acc[emp.department || "Unknown"] || 0) + 1;
      return acc;
    }, {});
  ...
  console.log(`👤 Generated by: ${userName} (${userLogin})`);
};

// Utility formatter if needed outside
